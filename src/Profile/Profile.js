    ...
    <ThemeProvider theme={theme}>
      <Box sx={{ padding: 3, marginTop: 2, borderRadius: 2, width: '60%', marginLeft: '20%', marginRight: '20%' }}>
        <Box sx={{ display: 'flex', alignItems: 'center', flexDirection: 'column', justifyContent: 'center', marginBottom: 3 }}>
          ...
          <Button variant="contained"  size="small" sx={{ mt: 1,color:"white",backgroundColor:"#E50000",fontWeight:"bold" }} onClick={() => document.getElementById('avatar-upload').click()}>Edit Photo</Button>
       </Box>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 5 }}>
          <Button sx={{ width: '50%', padding:'1%', marginRight:'25%',color:"white",backgroundColor:"#E50000",fontWeight:"bold" }} variant="contained"  onClick={handleSaveChanges}>Save Changes</Button>
        </Box>
      </Box>
    </ThemeProvider>
  );
